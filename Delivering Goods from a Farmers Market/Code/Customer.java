...
public class Customer
{
     ...
     */
    public Customer(String iD, ArrayList<Need> ListOfNeeds, City city)
    {
        this.iD = iD;
    ...
    /**
     * A getter method for the city the Customer has been assigned to 
     * 
     * @return the city reference number the customer is in
     */
    public int getCity()
    {
        return city.getCityReference();
    }
