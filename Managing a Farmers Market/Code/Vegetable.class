...
public class Vegetable<E> extends AbstractQueue<E> implements Queue<E>
{
    /**
     * This creates a Queue of type E (It can be any type, the type Object is used in the project.)
     * 
     */
    public Queue<E> VegetableQueue;
    ...
    public Vegetable()
    {
      VegetableQueue = new LinkedList<E>();
    }
  ...
  public Iterator<E> iterator(){
      ...
      Iterator<E> printer =   VegetableQueue.iterator();
