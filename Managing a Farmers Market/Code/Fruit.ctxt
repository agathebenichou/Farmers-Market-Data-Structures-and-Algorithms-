...
public class Fruit<E> extends AbstractQueue<E> implements Queue<E>
{
    /**
     * This creates a Queue of type E (It can be any type, the type Object is used in the project.)
     * 
     */
    public Queue<E> FruitQueue;
  ...
  public Iterator<E> iterator(){
      ...
      Iterator<E> printer =  FruitQueue.iterator();
