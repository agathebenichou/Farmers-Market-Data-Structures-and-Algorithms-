...
public class Beverages<E> extends AbstractQueue<E> implements Queue<E>
{
     /**
     * This creates a Queue of type E (It can be any type, the type Object is used in the project.)
     * 
     */
    public Queue<E> BeveragesQueue;
    ...
    public Beverages()
    {
        BeveragesQueue = new LinkedList<E>();
    }
  ...
  public Iterator<E> iterator(){
      ...
      Iterator<E> printer =  BeveragesQueue.iterator();
